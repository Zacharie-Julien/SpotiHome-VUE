...
public class MusicWAR {
    ...
    public Response addMusic(Music musique) {
        LOGGER.info("Appel à /addMusic (JSON)");
        try {
            musicEjb.addMusic(musique);
            return Response.status(Response.Status.CREATED).build();
        } catch (Exception e) {
            LOGGER.log(Level.SEVERE, "Erreur lors de l'ajout de musique via JSON", e);
